...
import trimesh
from giga.ConvONets.common import make_3d_grid, normalize_coord, add_key, coord2index
try:
    from giga.ConvONets.utils import libmcubes
    from giga.ConvONets.utils.libsimplify import simplify_mesh
    from giga.ConvONets.utils.libmise import MISE
except:
